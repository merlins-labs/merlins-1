...
merlin add-genesis-account $(merlin keys show validator1 -a --keyring-backend=test --home=$HOME/.merlin/validator1) 100000000000ufury,100000000000stake --home=$HOME/.merlin/validator1
merlin gentx validator1 500000000ufury --keyring-backend=test --home=$HOME/.merlin/validator1 --chain-id=testing
...
sleep 7
merlin tx bank send validator1 $(merlin keys show validator2 -a --keyring-backend=test --home=$HOME/.merlin/validator2) 500000000ufury --keyring-backend=test --home=$HOME/.merlin/validator1 --chain-id=testing --broadcast-mode block --node http://localhost:26657 --yes
merlin tx bank send validator1 $(merlin keys show validator3 -a --keyring-backend=test --home=$HOME/.merlin/validator3) 400000000ufury --keyring-backend=test --home=$HOME/.merlin/validator1 --chain-id=testing --broadcast-mode block --node http://localhost:26657 --yes

# create second & third validator
merlin tx staking create-validator --amount=500000000ufury --from=validator2 --pubkey=$(merlin tendermint show-validator --home=$HOME/.merlin/validator2) --moniker="validator2" --chain-id="testing" --commission-rate="0.1" --commission-max-rate="0.2" --commission-max-change-rate="0.05" --min-self-delegation="500000000" --keyring-backend=test --home=$HOME/.merlin/validator2 --broadcast-mode block --node http://localhost:26657 --yes
merlin tx staking create-validator --amount=400000000ufury --from=validator3 --pubkey=$(merlin tendermint show-validator --home=$HOME/.merlin/validator3) --moniker="validator3" --chain-id="testing" --commission-rate="0.1" --commission-max-rate="0.2" --commission-max-change-rate="0.05" --min-self-delegation="400000000" --keyring-backend=test --home=$HOME/.merlin/validator3 --broadcast-mode block --node http://localhost:26657 --yes
