...
var (
	cubeRootTwo, _        = furymath.NewBigDec(2).ApproxRoot(3)
	threeRootTwo, _       = furymath.NewBigDec(3).ApproxRoot(2)
	cubeRootThree, _      = furymath.NewBigDec(3).ApproxRoot(3)
	threeCubeRootTwo      = cubeRootTwo.MulInt64(3)
	cubeRootSixSquared, _ = (furymath.NewBigDec(6).MulInt64(6)).ApproxRoot(3)
	twoCubeRootThree      = cubeRootThree.MulInt64(2)
	twentySevenRootTwo, _ = furymath.NewBigDec(27).ApproxRoot(2)
)

// CFMMTestCase defines a testcase for stableswap pools
type CFMMTestCase struct {
	xReserve    furymath.BigDec
	yReserve    furymath.BigDec
	remReserves []furymath.BigDec
	yIn         furymath.BigDec
	expectPanic bool
}

var (
	overflowDec           = furymath.NewDecFromBigInt(new(big.Int).Sub(new(big.Int).Exp(big.NewInt(2), big.NewInt(1024), nil), big.NewInt(1)))
	twoAssetCFMMTestCases = map[string]CFMMTestCase{
		// sanity checks
		"small pool small input": {
			xReserve:    furymath.NewBigDec(100),
			yReserve:    furymath.NewBigDec(100),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(1),
			expectPanic: false,
		},
		"small pool large input": {
			...
			yReserve:    furymath.NewBigDec(100),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(99),
			expectPanic: false,
		},
		"medium pool medium join": {
			xReserve:    furymath.NewBigDec(100000),
			yReserve:    furymath.NewBigDec(100000),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(10000),
			expectPanic: false,
		},
		"large pool medium join": {
			xReserve:    furymath.NewBigDec(10000000),
			yReserve:    furymath.NewBigDec(10000000),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(10000),
			expectPanic: false,
		},
		"large pool large join": {
			...
			yReserve:    furymath.NewBigDec(10000000),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(1000000),
			expectPanic: false,
		},
		"very large pool medium join": {
			xReserve:    furymath.NewBigDec(1000000000),
			yReserve:    furymath.NewBigDec(1000000000),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(100000),
			expectPanic: false,
		},
		"billion token pool hundred million token join": {
			...
			yReserve:    furymath.NewBigDec(1000000000),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(100000000),
			expectPanic: false,
		},
		...
		"xReserve double yReserve (small)": {
			xReserve:    furymath.NewBigDec(100),
			yReserve:    furymath.NewBigDec(50),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(1),
			expectPanic: false,
		},
		"yReserve double xReserve (small)": {
			xReserve:    furymath.NewBigDec(50),
			yReserve:    furymath.NewBigDec(100),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(1),
			expectPanic: false,
		...
		"xReserve double yReserve (large)": {
			xReserve:    furymath.NewBigDec(13789470),
			yReserve:    furymath.NewBigDec(59087324),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(1047829),
			expectPanic: false,
		},
		"yReserve double xReserve (large)": {
			xReserve:    furymath.NewBigDec(50000000),
			yReserve:    furymath.NewBigDec(100000000),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(1000000),
			expectPanic: false,
		},
		"uneven medium pool medium join": {
			xReserve:    furymath.NewBigDec(123456),
			yReserve:    furymath.NewBigDec(434245),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(23314),
			expectPanic: false,
		},
		"uneven large pool medium join": {
			xReserve:    furymath.NewBigDec(11023432),
			yReserve:    furymath.NewBigDec(17432897),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(89734),
			expectPanic: false,
		},
		"uneven large pool large join": {
			xReserve:    furymath.NewBigDec(38987364),
			yReserve:    furymath.NewBigDec(52893462),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(9819874),
			expectPanic: false,
		},
		"uneven very large pool medium join": {
			xReserve:    furymath.NewBigDec(1473891748),
			yReserve:    furymath.NewBigDec(7438971234),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(100000),
			expectPanic: false,
		},
		"uneven billion token pool billion token join": {
			xReserve:    furymath.NewBigDec(2678238934),
			yReserve:    furymath.NewBigDec(1573917894),
			remReserves: []furymath.BigDec{},
			yIn:         furymath.NewBigDec(5378748),
			expectPanic: false,
		},
	...
	multiAssetCFMMTestCases = map[string]CFMMTestCase{
		...
		"even 3-asset small pool, small input": {
			...
			remReserves: []furymath.BigDec{furymath.NewBigDec(100)},
			yIn:         furymath.NewBigDec(1),
			expectPanic: false,
		},
		"even 3-asset medium pool, small input": {
			...
			remReserves: []furymath.BigDec{furymath.NewBigDec(100000)},
			yIn:         furymath.NewBigDec(100),
			expectPanic: false,
		},
		"even 4-asset small pool, small input": {
			...
			remReserves: []furymath.BigDec{furymath.NewBigDec(100), furymath.NewBigDec(100)},
			yIn:         furymath.NewBigDec(1),
			expectPanic: false,
		},
		"even 4-asset medium pool, small input": {
			...
			remReserves: []furymath.BigDec{furymath.NewBigDec(100000), furymath.NewBigDec(100000)},
			yIn:         furymath.NewBigDec(1),
			expectPanic: false,
		},
		"even 4-asset large pool (100M each), small input": {
			xReserve: furymath.NewBigDec(100000000),
			yReserve: furymath.NewBigDec(100000000),
			// represents a 4-asset pool with 100M in each reserve
			remReserves: []furymath.BigDec{furymath.NewBigDec(100000000), furymath.NewBigDec(100000000)},
			yIn:         furymath.NewBigDec(100),
			expectPanic: false,
		},
		"even 4-asset pool (10B each post-scaled), small input": {
			xReserve: furymath.NewBigDec(10000000000),
			yReserve: furymath.NewBigDec(10000000000),
			// represents a 4-asset pool with 10B in each reserve
			remReserves: []furymath.BigDec{furymath.NewBigDec(10000000000), furymath.NewBigDec(10000000000)},
			yIn:         furymath.NewBigDec(100000000),
			expectPanic: false,
		},
		"even 10-asset pool (10B each post-scaled), small input": {
			xReserve: furymath.NewBigDec(10_000_000_000),
			yReserve: furymath.NewBigDec(10_000_000_000),
			// represents a 10-asset pool with 10B in each reserve
			remReserves: []furymath.BigDec{furymath.NewBigDec(10_000_000_000), furymath.NewBigDec(10_000_000_000), furymath.NewBigDec(10_000_000_000), furymath.NewBigDec(10_000_000_000), furymath.NewBigDec(10_000_000_000), furymath.NewBigDec(10_000_000_000), furymath.NewBigDec(10_000_000_000), furymath.NewBigDec(10_000_000_000)},
			yIn:         furymath.NewBigDec(100),
			expectPanic: false,
		},
		"even 10-asset pool (100B each post-scaled), large input": {
			xReserve: furymath.NewBigDec(100_000_000_000),
			yReserve: furymath.NewBigDec(100_000_000_000),
			// represents a 10-asset pool with 100B in each reserve
			remReserves: []furymath.BigDec{furymath.NewBigDec(100_000_000_000), furymath.NewBigDec(100_000_000_000), furymath.NewBigDec(100_000_000_000), furymath.NewBigDec(100_000_000_000), furymath.NewBigDec(100_000_000_000), furymath.NewBigDec(100_000_000_000), furymath.NewBigDec(100_000_000_000), furymath.NewBigDec(100_000_000_000)},
			yIn:         furymath.NewBigDec(10_000_000_000),
			expectPanic: false,
		},
		...
		"uneven 3-asset pool, uneven swap assets as pool minority, x > y": {
			xReserve: furymath.NewBigDec(200),
			yReserve: furymath.NewBigDec(100),
			// the asset not being swapped has 100,000 token reserves (swap assets in pool minority)
			remReserves: []furymath.BigDec{furymath.NewBigDec(100000)},
			yIn:         furymath.NewBigDec(10),
		...
		"uneven 3-asset pool, no round numbers": {
			xReserve: furymath.NewBigDec(1178349),
			yReserve: furymath.NewBigDec(8329743),
			// the asset not being swapped has 329,847 token reserves (swap assets in pool minority)
			remReserves: []furymath.BigDec{furymath.NewBigDec(329847)},
			yIn:         furymath.NewBigDec(10),
			expectPanic: false,
		},
		...
		"uneven 4-asset pool, uneven swap assets in pool majority, y > x": {
			xReserve: furymath.NewBigDec(100000),
			yReserve: furymath.NewBigDec(200000),
			// the assets not being swapped have 100 token reserves each (swap assets in pool majority)
			remReserves: []furymath.BigDec{furymath.NewBigDec(100), furymath.NewBigDec(100)},
			yIn:         furymath.NewBigDec(10),
			expectPanic: false,
		...
		"uneven 4-asset pool, uneven swap assets in pool majority, y < x": {
			xReserve: furymath.NewBigDec(200000),
			yReserve: furymath.NewBigDec(100000),
			// the assets not being swapped have 100 token reserves each (swap assets in pool majority)
			remReserves: []furymath.BigDec{furymath.NewBigDec(100), furymath.NewBigDec(100)},
			yIn:         furymath.NewBigDec(10),
		...
		"uneven 4-asset pool, no round numbers": {
			...
			remReserves: []furymath.BigDec{furymath.NewBigDec(329847), furymath.NewBigDec(4372897)},
			yIn:         furymath.NewBigDec(10),
			expectPanic: false,
		},
		...
		"remReserve overflows in 3-asset pool": {
			xReserve:    furymath.NewBigDec(100),
			yReserve:    furymath.NewBigDec(100),
			remReserves: []furymath.BigDec{overflowDec},
			yIn:         furymath.NewBigDec(1),
			expectPanic: true,
		},
		"remReserve overflows in 4-asset pool": {
			xReserve:    furymath.NewBigDec(100),
			yReserve:    furymath.NewBigDec(100),
			remReserves: []furymath.BigDec{furymath.NewBigDec(100), overflowDec},
			yIn:         furymath.NewBigDec(1),
			expectPanic: true,
		},
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			sut := func() {
				...
				furymath.DecApproxEq(t, k0, k1, kErrTolerance)
			}
...
func solveCfmmDirect(xReserve, yReserve, yIn furymath.BigDec) furymath.BigDec {
	...
	scaled_y4_quo_k := (y4.Quo(k)).Mul(furymath.NewBigDec(2).Quo(twentySevenRootTwo))
	scaled_y4_quo_k2 := scaled_y4_quo_k.Mul(scaled_y4_quo_k)

	// let sqrt_term = sqrt(1 + scaled_y4_quo_k2)
	sqrt_term, err := (furymath.OneDec().Add(scaled_y4_quo_k2)).ApproxRoot(2)
	if err != nil {
		panic(err)
	}

	// let common_factor = [y^2 * 9k) * (sqrt_term + 1)]^(1/3)
	common_factor, err := (y2.MulInt64(9).Mul(k).Mul((sqrt_term.Add(furymath.OneDec())))).ApproxRoot(3)
	if err != nil {
		panic(err)
	}
...
// solidly CFMM is xy(x^2 + y^2) = k
func cfmmConstant(xReserve, yReserve furymath.BigDec) furymath.BigDec {
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			sut := func() {
				...
				furymath.DecApproxEq(t, k2, k3, kErrTolerance)
			}
...
func cfmmConstantMulti(xReserve, yReserve, u, v furymath.BigDec) furymath.BigDec {
	if !u.IsPositive() {
		panic("invalid input: reserves must be positive")
	}
...
// Since original reserves, y' and k are known and remain constant throughout the calculation,
// deriving x' and then finding x_out is equivalent to finding x_out directly.
func solveCFMMMultiDirect(xReserve, yReserve, wSumSquares, yIn furymath.BigDec) furymath.BigDec {
...
func calcUReserve(remReserves []furymath.BigDec) furymath.BigDec {
	uReserve := furymath.OneDec()
...
func calcWSumSquares(remReserves []furymath.BigDec) furymath.BigDec {
