...
```sh
merlin tx tokenfactory mint 100000000000factory/fury1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo --keyring-backend=test --from mylocalwallet
```
...
```sh
merlin query bank denom-metadata --denom factory/fury1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo
```
...
```sh
merlin query tokenfactory denoms-from-creator fury1c584m4lq25h83yp6ag8hh4htjr92d954vklzja
```
