...
import (
	...
	clkeeper "github.com/merlins-labs/merlin/x/concentrated-liquidity"
	clmodeltypes "github.com/merlins-labs/merlin/x/concentrated-liquidity/model"
...
func RandMsgCreatePosition(k clkeeper.Keeper, sim *mersimtypes.SimCtx, ctx sdk.Context) (*cltypes.MsgCreatePosition, error) {
	// get random pool
...
func RandMsgWithdrawPosition(k clkeeper.Keeper, sim *mersimtypes.SimCtx, ctx sdk.Context) (*cltypes.MsgWithdrawPosition, error) {
	rand := sim.GetRand()
	// get random pool
...
func RandMsgCollectSpreadRewards(k clkeeper.Keeper, sim *mersimtypes.SimCtx, ctx sdk.Context) (*cltypes.MsgCollectSpreadRewards, error) {
	// get random pool
	clPool, poolDenoms, err := getRandCLPool(k, sim, ctx)
	if err != nil {
		return nil, err
...
func RandMsgCollectIncentives(k clkeeper.Keeper, sim *mersimtypes.SimCtx, ctx sdk.Context) (*cltypes.MsgCollectIncentives, error) {
	// get random pool
	clPool, poolDenoms, err := getRandCLPool(k, sim, ctx)
	if err != nil {
		return nil, err
...
func getRandCLPool(k clkeeper.Keeper, sim *mersimtypes.SimCtx, ctx sdk.Context) (cltypes.ConcentratedPoolExtension, []string, error) {
	rand := sim.GetRand()
...
func getRandomTickPositions(sim *mersimtypes.SimCtx, minTick, maxTick int64, tickSpacing uint64) (int64, int64, error) {
...
func RandomMinAmount(sim *mersimtypes.SimCtx, token0Desired, token1Desired sdk.Int) (sdk.Int, sdk.Int) {
	rand := sim.GetRand()
...
func RandomTickDivisibility(sim *mersimtypes.SimCtx, minTick int64, maxTick int64, tickSpacing uint64) (int64, error) {
	rand := sim.GetRand()
...
func RandomPreparePoolFunc(sim *mersimtypes.SimCtx, ctx sdk.Context, k clkeeper.Keeper) (sdk.AccAddress, sdk.Coin, sdk.Coin, uint64, sdk.Dec, error) {
	rand := sim.GetRand()
...
func RandomPrepareCreatePositionFunc(sim *mersimtypes.SimCtx, ctx sdk.Context, clPool cltypes.ConcentratedPoolExtension, poolDenoms []string) (sdk.AccAddress, sdk.Coins, int64, int64, error) {
