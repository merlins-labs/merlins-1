	...
	tests := []struct {
	...
	}{
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.NewCoins(sdk.NewCoin("stake", sdk.OneInt()), sdk.NewCoin("mer", sdk.OneInt())),
		...
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.Coins{sdk.Coin{Denom: "stake", Amount: sdk.NewInt(-10)}, sdk.NewCoin("mer", sdk.OneInt())},
				TokenMinAmount0: sdk.OneInt(),
				TokenMinAmount1: sdk.OneInt(),
			},
			expectPass: false,
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.Coins{sdk.NewCoin("stake", sdk.OneInt()), sdk.Coin{Denom: "mer", Amount: sdk.NewInt(-10)}},
				TokenMinAmount0: sdk.OneInt(),
				TokenMinAmount1: sdk.OneInt(),
			},
			expectPass: false,
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.NewCoins(sdk.NewCoin("stake", sdk.ZeroInt()), sdk.NewCoin("mer", sdk.ZeroInt())),
				TokenMinAmount0: sdk.OneInt(),
				TokenMinAmount1: sdk.OneInt(),
			},
			expectPass: false,
