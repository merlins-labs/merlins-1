...
func init() {
	...
	proto.RegisterType((*MsgAddToPosition)(nil), "merlin.concentratedliquidity.v1beta1.MsgAddToPosition")
	proto.RegisterType((*MsgAddToPositionResponse)(nil), "merlin.concentratedliquidity.v1beta1.MsgAddToPositionResponse")
	...
	proto.RegisterType((*MsgCollectSpreadRewards)(nil), "merlin.concentratedliquidity.v1beta1.MsgCollectSpreadRewards")
	proto.RegisterType((*MsgCollectSpreadRewardsResponse)(nil), "merlin.concentratedliquidity.v1beta1.MsgCollectSpreadRewardsResponse")
	proto.RegisterType((*MsgCollectIncentives)(nil), "merlin.concentratedliquidity.v1beta1.MsgCollectIncentives")
	proto.RegisterType((*MsgCollectIncentivesResponse)(nil), "merlin.concentratedliquidity.v1beta1.MsgCollectIncentivesResponse")
	proto.RegisterType((*MsgFungifyChargedPositions)(nil), "merlin.concentratedliquidity.v1beta1.MsgFungifyChargedPositions")
	proto.RegisterType((*MsgFungifyChargedPositionsResponse)(nil), "merlin.concentratedliquidity.v1beta1.MsgFungifyChargedPositionsResponse")
}
...
func (c *msgClient) AddToPosition(ctx context.Context, in *MsgAddToPosition, opts ...grpc.CallOption) (*MsgAddToPositionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.concentratedliquidity.v1beta1.Msg/AddToPosition", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CollectSpreadRewards(ctx context.Context, in *MsgCollectSpreadRewards, opts ...grpc.CallOption) (*MsgCollectSpreadRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.concentratedliquidity.v1beta1.Msg/CollectSpreadRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CollectIncentives(ctx context.Context, in *MsgCollectIncentives, opts ...grpc.CallOption) (*MsgCollectIncentivesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.concentratedliquidity.v1beta1.Msg/CollectIncentives", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddToPosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.concentratedliquidity.v1beta1.Msg/AddToPosition",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CollectSpreadRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.concentratedliquidity.v1beta1.Msg/CollectSpreadRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CollectIncentives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.concentratedliquidity.v1beta1.Msg/CollectIncentives",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
