...
import (
	...
	types2 "github.com/merlins-labs/merlin/v16/x/lockup/types"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
func init() {
	...
	proto.RegisterType((*FullPositionBreakdown)(nil), "merlin.concentratedliquidity.v1beta1.FullPositionBreakdown")
	proto.RegisterType((*PositionWithPeriodLock)(nil), "merlin.concentratedliquidity.v1beta1.PositionWithPeriodLock")
}
...
var fileDescriptor_ffdfd7b30d37d326 = []byte{
	...
	0x41, 0x13, 0x3a, 0xa4, 0x21, 0x71, 0x0c, 0x08, 0x69, 0x12, 0x87, 0x11, 0x86, 0x90, 0x10, 0x52,
	...
	,
	...
	0xff, 0xc4, 0x18, 0xd4, 0x6d, 0x40, 0x06, 0x00, 0x00,
}
