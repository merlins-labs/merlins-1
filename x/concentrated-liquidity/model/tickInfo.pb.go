...
func init() {
	...
	proto.RegisterType((*UptimeTrackers)(nil), "merlin.concentratedliquidity.v1beta1.UptimeTrackers")
	proto.RegisterType((*UptimeTracker)(nil), "merlin.concentratedliquidity.v1beta1.UptimeTracker")
}
