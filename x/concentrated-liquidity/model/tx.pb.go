...
// source: merlin/concentrated-liquidity/pool-model/concentrated/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateConcentratedPool)(nil), "merlin.concentratedliquidity.poolmodel.concentrated.v1beta1.MsgCreateConcentratedPool")
	proto.RegisterType((*MsgCreateConcentratedPoolResponse)(nil), "merlin.concentratedliquidity.poolmodel.concentrated.v1beta1.MsgCreateConcentratedPoolResponse")
}

func init() {
	proto.RegisterFile("merlin/concentrated-liquidity/pool-model/concentrated/tx.proto", fileDescriptor_dde1ce763867060f)
}
...
func (c *msgClient) CreateConcentratedPool(ctx context.Context, in *MsgCreateConcentratedPool, opts ...grpc.CallOption) (*MsgCreateConcentratedPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.concentratedliquidity.poolmodel.concentrated.v1beta1.Msg/CreateConcentratedPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateConcentratedPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.concentratedliquidity.poolmodel.concentrated.v1beta1.Msg/CreateConcentratedPool",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlin.concentratedliquidity.poolmodel.concentrated.v1beta1.Msg",
	...
	Metadata: "merlin/concentrated-liquidity/pool-model/concentrated/tx.proto",
}
