...
func (k Keeper) GetSuperfluidMERTokens(ctx sdk.Context, denom string, amount sdk.Int) (sdk.Int, error) {
	...
	return k.GetRiskAdjustedMerValue(ctx, decAmt.RoundInt()), nil
}
