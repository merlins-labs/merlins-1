...
// source: merlin/pool-incentives/v1beta1/shared.proto
...
func init() {
	proto.RegisterType((*MigrationRecords)(nil), "merlin.poolincentives.v1beta1.MigrationRecords")
	proto.RegisterType((*BalancerToConcentratedPoolLink)(nil), "merlin.poolincentives.v1beta1.BalancerToConcentratedPoolLink")
}

func init() {
	proto.RegisterFile("merlin/pool-incentives/v1beta1/shared.proto", fileDescriptor_f1449a8a614d7aea)
}
