...
pub mod tests {
    ...
    fn send_native() {
        ...
        assert_eq!(packet.local_denom(&FlowType::Out), "ufury");
    }
    ...
    fn receive_native() {
        ...
        let packet = Packet::mock(
            format!("channel-42-counterparty"), // The counterparty's channel is the source here
            format!("channel-17-local"),        // Our channel is the dest channel
            format!("transfer/channel-42-counterparty/ufury"),
            0_u128.into(),
        );
    ...
    fn sanity_check() {
        ...
        // fury on the hub sent back to merlin
        // send
        let packet = Packet::mock(
            format!("channel-141"),                // from: hub
            format!("channel-0"),                  // to: merlin
        ...
        // ufury on the hub sent back to the merlin
        let packet = Packet::mock(
            format!("channel-141"),                // from: hub
            format!("channel-0"),                  // to: merlin
            WRAPPED_FURY_ON_HUB_TRACE.to_string(), // unwrapped before reaching the contract
    ...
    fn tokenfactory_packet() {
        let json = r#"{"send_packet":{"packet":{"sequence":4,"source_port":"transfer","source_channel":"channel-0","destination_port":"transfer","destination_channel":"channel-1491","data":{"denom":"transfer/channel-0/factory/fury12smx2wdlyttvyzvzg54y2vnqwq2qjateuf7thj/czar","amount":"100000000000000000","sender":"fury1cyyzpxplxdzkeea7kwsydadg87357qnahakaks","receiver":"fury1c584m4lq25h83yp6ag8hh4htjr92d954vklzja"},"timeout_height":{},"timeout_timestamp":1668024476848430980}}}"#;
    ...
    fn packet_with_memo() {
        ...
        let json = r#"{"recv_packet":{"packet":{"sequence":1,"source_port":"transfer","source_channel":"channel-0","destination_port":"transfer","destination_channel":"channel-0","data":{"denom":"stake","amount":"1","sender":"fury177uaalkhra6wth6hc9hu79f72eq903kwcusx4r","receiver":"fury1fj6yt4pwfea4865z763fvhwktlpe020ef93dlq","memo":"some info"},"timeout_height":{"revision_height":100}}}}"#;
