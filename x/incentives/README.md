...
Anyone can create a gauge and add rewards to the gauge. There is no way to withdraw gauge rewards other than distribution. Governance proposals can be raised to match the external incentive tokens with equivalent Fury incentives (see for example: [proposal 47](https://www.mintscan.io/merlin/proposals/47)).
