...
```bash
merlin tx lockup lock-tokens 25527546134174465309gamm/pool/13 --duration="168h" --from WALLET_NAME --chain-id fury-test-4
```
...
```bash
merlin query lockup account-locked-coins fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259
```
...
```bash
merlin query lockup account-locked-longer-duration fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259 24h
```
...
```bash
merlin query lockup account-locked-longer-duration-denom fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259 24h gamm/pool/3
```
...
```bash
merlin query lockup account-locked-longer-duration-not-unlocking fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259 24h
```
...
```bash
merlin query lockup account-locked-pasttime fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259 1639971082
```
...
```bash
merlin query lockup account-locked-pasttime-denom fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259 [timestamp] [denom]
```
...
```bash
merlin query lockup account-locked-pasttime-denom fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259 1639971082 gamm/pool/3
```
...
```bash
merlin query lockup account-unlocking-coins fury1xqhlshlhs5g0acqgrkafdemvf5kz4pp4c2x259
```
