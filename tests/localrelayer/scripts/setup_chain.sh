...
add_genesis_accounts () {
    ...
    merlin add-genesis-account $VALIDATOR_ACCOUNT 100000000000ufury,100000000000uion,100000000000stake --home $MERLIN_HOME
    ...
    merlin add-genesis-account $FAUCET_ACCOUNT 100000000000ufury,100000000000uion,100000000000stake --home $MERLIN_HOME
    ...
    merlin add-genesis-account $RELAYER_ACCOUNT 1000000000ufury,1000000000uion,1000000000stake --home $MERLIN_HOME
    
    merlin gentx $VALIDATOR_MONIKER 500000000ufury --keyring-backend=test --chain-id=$CHAIN_ID --home $MERLIN_HOME
