...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	if err != nil {
		...
		homeDir = merlin.DefaultNodeHome
	}
...
func getHomeEnvironment() string {
	envPath := filepath.Join(merlin.DefaultNodeHome, ".env")
...
func createMerlinAppAndExport(
	...
	app := merlin.NewMerlinApp(logger, db, traceStore, loadLatest, map[int64]bool{}, homeDir, 0, appOpts, merlin.EmptyWasmOpts)
