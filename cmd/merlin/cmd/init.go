	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			seeds := []string{
				...
				"ebc272824924ea1a27ea3183dd0b9ba713494f83@merlin-mainnet-seed.autostake.com:26716",        // AutoStake.com
