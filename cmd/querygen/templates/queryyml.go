...
type QueryYml struct {
	...
	// Path to client folder e.g. "github.com/merlins-labs/merlin/v16/x/twap/client"
...
type Keeper struct {
	// e.g. github.com/merlins-labs/merlin/v16/x/twap
...
// input is of form github.com/merlins-labs/merlin/vXX/{PATH}
// returns PATH
